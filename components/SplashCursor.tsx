...
function mutedPaletteColor(): { r:number; g:number; b:number } {
  // a set of low-saturation pastels suitable for light minimal UIs
  const palette = [
    { r: 0.75, g: 0.80, b: 0.86 }, // soft blue-gray
    { r: 0.88, g: 0.80, b: 0.86 }, // soft mauve
    { r: 0.86, g: 0.87, b: 0.75 }, // soft green-beige
    { r: 0.95, g: 0.88, b: 0.80 }, // warm cream
  ];
