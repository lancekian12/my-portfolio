    ...
    <div className="fixed bottom-4 right-4 z-50">
      {!open ? (
        <button
          ...
          className="group flex items-center gap-3 rounded-full border border-white/10 bg-black px-4 py-3 text-white shadow-2xl transition-all duration-300 hover:scale-[1.03] hover:bg-slate-900"
        ...
        >
          ...
          <div className="flex flex-col items-start leading-tight">
            ...
            <span className="text-xs text-slate-400">Ask me anything</span>
          </div>
        </button>
      ) : (
          ...
          <div className="flex-1 overflow-y-auto px-4 py-4">
            <div className="space-y-4">
              {messages.map((msg) => (
                ...
                >
                  {msg.role === "assistant" && (
                    <div className="h-8 w-8 shrink-0 overflow-hidden rounded-sm border border-slate-200 bg-white dark:border-slate-700 dark:bg-slate-800">
                      <Image
                        src="/images/kian3.jpg"
                        alt="Kian"
                        width={32}
