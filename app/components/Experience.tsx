...
const experiences: ExperienceItem[] = [

  {
    ...
    period: "2015 – 2026",
    description:
      "Im dedicated to develop a mobile and web development",
  },
    {
    ...
    description:
      "Leading a team of 4 developers to modernize enterprise dashboard architectures using React and TypeScript.",
  },
];
...
function Card({ exp }: { exp: ExperienceItem }) {
  return (
    <div className="bg-white dark:bg-slate-900/50 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
      ...
      <div className="text-slate-600 font-medium mb-3">{exp.role}</div>
